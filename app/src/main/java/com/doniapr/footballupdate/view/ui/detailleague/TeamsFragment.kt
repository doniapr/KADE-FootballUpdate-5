...
import com.doniapr.footballupdate.adapter.leaguedetailadapter.TeamAdapter
...
import com.doniapr.footballupdate.view.viewinterface.TeamView
 ...
 */
class TeamsFragment(private val leagueId: Int) : Fragment(),
    TeamView {
